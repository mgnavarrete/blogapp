                            ...
                            <div class="row">
                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                    <div class="card custom-card">
                                        <a href="javascript:void(0);">
                                            <img src="{{asset('build/assets/images/media/media-36.jpg')}}" class="card-img-top" alt="...">
                                        </a>
                                        <div class="card-body">
                                            <a href="{{url('blog-details')}}" class="fw-semibold fs-14 text-dark mb-1">Touring excites in winter !</a>
                                ...
                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                    <div class="card custom-card">
                                        <a href="javascript:void(0);">
                                            <img src="{{asset('build/assets/images/media/media-35.jpg')}}" class="card-img-top" alt="...">
                                        </a>
                                        <div class="card-body">
                                            <a href="{{url('blog-details')}}" class="fw-semibold fs-14 text-dark mb-1"> Boat manufacutrers are in debt !</a>
                                    ...
                                    <div class="row">
                                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                                            <div class="card custom-card">
                                                ...
                                                <div class="card-body">
                                                    <a href="{{url('blog-details')}}" class="fw-semibold fs-14 text-dark mb-1">Features of new car !</a>
                                                    <p class="card-text text-muted mb-3">The holographic principle, theorized to be a property of quantum gravity, postulates that the description.</p>
                                                    <a href="javascript:void(0);" class="btn btn-primary-light">Read More</a>
                                                </div>
                                                <div class="card-footer">
                                        ...
                                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                                            <div class="card custom-card">
                                                ...
                                                <div class="card-body">
                                                    <a href="{{url('blog-details')}}" class="fw-semibold fs-14 text-dark mb-1">Beautiful beach on a sunny day !</a>
                                                    <p class="card-text text-muted mb-3">The holographic principle, theorized to be a property of quantum gravity, postulates that the description.</p>
                                                    <a href="javascript:void(0);" class="btn btn-primary-light">Read More</a>
                                                </div>
                                                <div class="card-footer">
                        ...
                        <div class="col-xl-12">
                            <div class="row">
                                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="card custom-card">
                                        <a href="javascript:void(0);">
                                            <img src="{{asset('build/assets/images/media/media-40.jpg')}}" class="card-img-top" alt="...">
                                        </a>
                                        <div class="card-body">
                                            <a href="{{url('blog-details')}}" class="fw-semibold fs-14 text-dark mb-1">Strawberry juice recipe.</a>
                                ...
                                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <a href="{{url('blog-details')}}" class="fw-semibold fs-14 text-dark mb-1">Night Sky is pleasent to watch.</a>
                                ...
                                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="card custom-card">
                                        <a href="javascript:void(0);">
                                            <img src="{{asset('build/assets/images/media/media-42.jpg')}}" class="card-img-top" alt="...">
                                        </a>
                                        <div class="card-body">
                                            <a href="{{url('blog-details')}}" class="fw-semibold fs-14 text-dark mb-1">Is fashion industry growing ?</a>
                                            <p class="card-text text-muted mb-3">The holographic principle, theorized to be a property of quantum gravity, postulates that the description.</p>
                                            <a href="javascript:void(0);" class="btn btn-primary-light">Read More</a>
                                        </div>
                                        <div class="card-footer">
                                ...
                                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <a href="{{url('blog-details')}}" class="fw-semibold fs-14 text-dark mb-1">Raising sun is a blessing to watch ..</a>
